...
enrollment <- read_csv("../data/handmade/Data_10-28-2021.csv")
enrollment

```
```{r}
saveRDS(enrollment, file = "../data/processed/enrollment.rds")
...
#   pivot_wider(names_from = institution_name, values_from = counts) %>% 
#   clean_names
# 
# 
# x2 = enrollment %>% 
...
graph %>% 
  # filter(institution_name == "George Mason University") %>% 
