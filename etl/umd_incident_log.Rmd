...
umd_police_arrest_data <- read_csv("~/Code/university_police_logs/data/handmade/umd_police_arrest_data_2021_09_08.csv")
...
umd_police_arrest_summarized = umd_police_arrest_data %>% 
  group_by(umpd_case_number) %>% 
  mutate(number_arrests = length(unique(arrest_number)))
```
